...
/// Stores information characterizing a state in a non-deterministic transition system, see [`crate::NTS`].
...
/// Iterator over the edges in a [`crate::NTS`] that reach a certain state.
