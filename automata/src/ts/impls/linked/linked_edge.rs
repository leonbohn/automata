...
/// Represents an edge in a non-deterministic transition system, see [`crate::NTS`]. It stores a color, an
...
{
    fn into_edge_tuple(self) -> crate::ts::EdgeTuple<LinkedListTransitionSystem<A, Q, C, DET>> {
        (
